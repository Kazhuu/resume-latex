...
\hfill
\DatestampY{2021} -- Present
\Gap
\BulletItem CEO and Software Consultant
\begin{Detail}
    \SubBulletItem CEO and co-founder.
    \SubBulletItem Embedded and desktop application development with Rust, C/C++, Qt and ImGui.
    \SubBulletItem 3D viewer application development with Python.
    \SubBulletItem Zephyr RTOS embedded development with C.
    \SubBulletItem Full-stack web development with Ruby on Rails, Django, React.
    \SubBulletItem Application deployments and hosting with Docker, Kubernetes, Azure and AWS.
    \SubBulletItem Geolocation app development with Rust, PostgreSQL, PostGIS and MQTT.
    \SubBulletItem Deep knowledge of medical standards like HL7 FHIR and DICOM.
\end{Detail}
...
\begin{Detail}
    ...
    \SubBulletItem CI/CD with Jenkins and pipelines.
\end{Detail}
...
\Entry
\BulletItem AMQP and MQTT,
\BulletItem Altera FPGA,
\BulletItem Back-end (Ruby on Rails, Django, Rust),
\BulletItem C/C++,
\BulletItem CMake,
\BulletItem CPU and VLIW,
\BulletItem Databases (PostgreSQL, MySQL, Redis),
\BulletItem Docker and Kubernetes,
\BulletItem Embedded (ARMv7, AVR, Zephyr RTOS),
\BulletItem Front-end (AngularJS, React),
\BulletItem HL7 FHIR and DICOM,
\BulletItem HTML5, (S)CSS, SASS,
\BulletItem Java,
\BulletItem JavaScript,
\BulletItem Jenkins and CI/CD,
\BulletItem LLVM Compiler,
