...
\begin{Detail}
    ...
    \SubBulletItem Embedded and application development with Rust, C/C++, Qt and ImGui.
    \SubBulletItem Zephyr RTOS embedded development with C.
    \SubBulletItem Full-stack web development with Ruby on Rails, Django, React and Angular.
