...
\begin{Details}
    \SubBulletItem Responsible for customer relationships and meetings in Pirkanmaa region
    \SubBulletItem Embedded software design and developer (e.g. AVR, Linux, C/C++, Python)
...
\begin{Details}
    ...
    Django/Python and AngularJS with integration to Lemonsoft ERP
    ...
    flea market management (e.g. Knockout, JQuery, PHP)
